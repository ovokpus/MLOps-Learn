...
Experiment tracking helps with _Reproducibility_, _Organization_ and _Optimization_

Tracking experiments in spreadsheets helps but falls short in all the key points.

# MLflow:

_"An Open source platform for the machine learning lifecycle"_
...
- Models
- Model registry
- Projects (Out of scope for this learning project)
